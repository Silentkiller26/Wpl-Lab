                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="row">
									...
									<div class="col-md-6">
                                        ...
                                        <input type="text" name="address" id="address" placeholder="C2/1102, Celebrity Greens" class="form-control" required=""/>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="control-label" for="post_code">post code <span class="star-col">*</span></label>
                                        <input type="text" name="post_code" id="post_code" placeholder="395017" class="form-control" required="" pattern="[0-9]{4}" title="Bangladeshi Post Code Must Be 4 Digits Numeric"/>
                                    </div>
				    				<div class="col-md-6">
    								...
    								<div class="col-md-6">
                                        ...
                                        <input type="text" name="daily_price" id="daily_price" placeholder="Daily Rate of an Labour" class="form-control" required="" pattern="\d+(\.\d{2})?"  title="Input valid Price e.g. (500.00/500)"/>
                                    </div>
