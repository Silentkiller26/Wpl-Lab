                                    ...
                                    <form method="post" action="scheduleedit.php" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" name="available_place" id="available_place" placeholder="eg. Dhanmondi" class="form-control" value="<?php echo (isset($available_place))? $available_place:''; ?>" required=""/>
                                            </div>
									        <div class="col-md-10">
			    					        ...
			    					        <center>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <input type="hidden" value="<?php echo (isset($_GET["sno"]))? $sno:'';?>" name="sno"/>
